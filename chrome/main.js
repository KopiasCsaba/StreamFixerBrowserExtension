...
var add_callback_1 = __webpack_require__(29);
var add_reducer_1 = __webpack_require__(8);
var add_reducers_1 = __webpack_require__(9);
var create_provider_1 = __webpack_require__(30);
var decorator_1 = __webpack_require__(32);
var default_global_state_manager_1 = __webpack_require__(3);
var get_dispatch_1 = __webpack_require__(33);
var get_global_1 = __webpack_require__(34);
var remove_callback_1 = __webpack_require__(35);
var reset_global_1 = __webpack_require__(36);
var set_global_1 = __webpack_require__(5);
var use_dispatch_1 = __webpack_require__(16);
var use_global_1 = __webpack_require__(20);
var with_global_1 = __webpack_require__(21);
var with_init_1 = __webpack_require__(37);
...
Object.defineProperty(exports, "__esModule", { value: true });
var set_global_1 = __webpack_require__(5);
var get_global_state_manager_1 = __webpack_require__(15);
...
Object.defineProperty(exports, "__esModule", { value: true });
var global_state_manager_1 = __webpack_require__(7);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var methods_1 = __webpack_require__(2);
var bind_lifecycle_methods_1 = __webpack_require__(25);
...
Object.defineProperty(exports, "__esModule", { value: true });
var object_get_listener_1 = __webpack_require__(24);
...
function getSiteConfig() {
    ...
    if (document.getElementById('testarea') !== null) {
        return {
            name: "Test",
            getVideoName: (videoNode) => videoNode.closest('div').querySelector('span').innerText
        };
    }
    // WHEREBY
    if (url.match(/.*whereby.com\/[^/]+/g) && !url.match(/.*whereby.com\/user/g)) {
        return {
            name: "whereby",
            getVideoName: (videoNode) => videoNode.closest('div[class^="content-"]').querySelector('[class^="nameBanner-"]').innerText
        };
    }
    // JITSI
 ...
 * @param getvideoName
 */
exports.getPageParticipants = (getvideoName) => {
    let elements = [];
    document.querySelectorAll('video:not(.sfVideo)').forEach((node) => {
        if (!node.srcObject || !node.srcObject.id) {
            return;
        }
 ...
 */
function updateStateParticipants(stateParticipants, pageParticipants) {
    const updatedStateParticipants = Object.assign({}, stateParticipants);
    let changed = false;
    for (const pp of pageParticipants) {
        ...
        if (now) {
            ...
            if (stream !== null && stream instanceof MediaStream && stream.active) {
                ...
                changed = true;
                log_1.log("Adding new participant...");
    ...
    log_1.log("CHANGED:", changed);
    return updatedStateParticipants;
}
exports.updateStateParticipants = updateStateParticipants;
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __webpack_require__(0);
var use_force_update_1 = __webpack_require__(17);
var context_1 = __webpack_require__(4);
var default_global_state_manager_1 = __webpack_require__(3);
var is_property_reducer_1 = __webpack_require__(18);
var react_hooks_error_1 = __webpack_require__(19);
...
Object.defineProperty(exports, "__esModule", { value: true });
const reactn_1 = __webpack_require__(1);
const ReactDOM = __webpack_require__(38);
const App_1 = __webpack_require__(42);
const state_1 = __webpack_require__(53);
const ext_1 = __webpack_require__(13);
const log_1 = __webpack_require__(10);
/**
 * This is the entrypoint of the injected content script.
 */
const sc = ext_1.getSiteConfig();
if (sc != null) {
    // This means, that are on a site/sub page that we support.
    log_1.log("CONFIG", sc.name);
    state_1.initState(sc);
    const c = document.createElement("div");
    window.document.body.appendChild(c);
    ReactDOM.render(reactn_1.default.createElement(App_1.App, null), c);
}
...
var React = __webpack_require__(0);
var methods_1 = __webpack_require__(2);
var component_will_unmount_1 = __webpack_require__(26);
var component_will_update_1 = __webpack_require__(27);
var should_component_update_1 = __webpack_require__(28);
...
var use_global_1 = __webpack_require__(20);
var is_property_reducer_1 = __webpack_require__(18);
var react_context_error_1 = __webpack_require__(31);
var with_global_1 = __webpack_require__(21);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(14),r=__webpack_require__(40);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
const Overlay_1 = __webpack_require__(43);
const ext_1 = __webpack_require__(13);
const ext_2 = __webpack_require__(13);
let interval = null;
/**
 ...
 */
const update = () => {
    const sc = reactn_1.getGlobal().siteConfig;
    // These are the current participants in the original page itself.
    const pageParticipants = ext_1.getPageParticipants(sc.getVideoName);
    // These are the participants we know about.
    const stateParticipants = reactn_1.getGlobal().participants;
    // log("Updating", stateParticipants);
    // Merge the page participants into the state participants.
    const updatedStateParticipants = ext_2.updateStateParticipants(stateParticipants, pageParticipants);
    // log(updatedStateParticipants);
    if (updatedStateParticipants !== null) {
        // Update participant list if needed.
        reactn_1.setGlobal({ participants: updatedStateParticipants });
    }
};
/**
 ...
 */
function App() {
    react_1.useEffect(startWatching);
    return reactn_1.default.createElement("div", null,
        reactn_1.default.createElement(Overlay_1.Overlay, null));
}
exports.App = App;
...
const reactn_1 = __webpack_require__(1);
const react_1 = __webpack_require__(0);
const reactn_2 = __webpack_require__(1);
const ParticipantView_1 = __webpack_require__(44);
const Toolbar_1 = __webpack_require__(47);
const react_2 = __webpack_require__(0);
const bridge_1 = __webpack_require__(50);
const style = __webpack_require__(51);
/**
 ...
 */
function Overlay() {
    const overlayEl = react_2.useRef(null);
    const [isMinimised] = reactn_1.useGlobal("overlayMinimised");
    ...
    // Compile class list
    let overlayClasses = [style.customOverlay];
    if (isMinimised) {
    ...
    return reactn_2.default.createElement("div", { ref: overlayEl, className: overlayClasses.join(" ") },
...
const react_2 = __webpack_require__(0);
const log_1 = __webpack_require__(10);
const style = __webpack_require__(45);
function ParticipantView(props) {
    if (!props.participant) {
        return reactn_2.default.createElement("span", null);
    }
    const videoEl = react_2.useRef(null);
    react_1.useEffect(() => {
    ...
    const [participants, setParticipants] = reactn_1.useGlobal("participants");
    /**
     * Removes this instance from the state.
     */
    const onRemove = () => {
        const newParticipants = Object.assign({}, participants);
        log_1.log(newParticipants, props.participant.name);
...
exports.locals = {
	...
	"participantView": "_1tscJREj325ASxQO5thofe"
};
...
const reactn_1 = __webpack_require__(1);
const reactn_2 = __webpack_require__(1);
const style = __webpack_require__(48);
/**
...
function Toolbar(props) {
    const [isMinimised, setMinimised] = reactn_1.useGlobal("overlayMinimised");
    const [isSmall, setSmall] = reactn_1.useGlobal("overlaySmall");
    const [_, setParticipants] = reactn_1.useGlobal("participants");
    const [guestMode, setGuestMode] = reactn_1.useGlobal("guestMode");
 ...
 * @param height
 */
exports.updateWindowSize = (off, height) => {
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "._34dJHDWM2R15Z9wHYUQ6Ro {\n    visibility: visible;\n    width: 100%;\n    min-width: 150px;\n    position: absolute;\n    right: 0px;\n    top: 0px;\n    background: rgba(0.5, 0.5, 0.5, 0.5);\n    text-align: right;\n    z-index: 9999999;\n}\n\n.fXpPFUefn5UZIJggN9nGX {\n    width: 250px;\n}\n\n._1lHTB7cEXcwoX_m3DBDgdt ._1V-k7my-zA1q1XoE5FDNYp {\n    display: none;\n}\n\n._1V-k7my-zA1q1XoE5FDNYp {\n    background: black;\n    display: flex;\n    flex-direction: column;\n}", ""]);
// Exports
exports.locals = {
	"customOverlay": "_34dJHDWM2R15Z9wHYUQ6Ro",
	"small": "fXpPFUefn5UZIJggN9nGX",
	"minimised": "_1lHTB7cEXcwoX_m3DBDgdt",
	"ovlcontainer": "_1V-k7my-zA1q1XoE5FDNYp"
};
module.exports = exports;
...
exports.initState = (sc) => {
    ...
    cfg.siteConfig = sc;
    reactn_1.setGlobal(cfg);
    reactn_1.addCallback(global => {
